...
<section class="is-title-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
	...
	<li style='color:lightblue'>Plumber</li>
      ...
      <li style='color:darkblue'>Scheduled Inspection</li>
			...
			<?php
		  		$id = $user['plumber_ID'];
						...
						LEFT JOIN tbladdress ON tbladdress.address_ID =  tblclients.address_ID
						 WHERE  inspection_schedule_for_registration_approval.inspect_visted =0 AND inspection_schedule_for_registration_approval.inspect_visted = 0 AND  plumber_ID = '$id'  ";
