					...
					?>
						...
						<form method='POST' >
							...
							<tr>
								...
								<td style='background:white'><input type='date' name="date" value="<?php echo $rw['date']?>" style="border:solid;border-color:lightblue;border-width:1px;width:100%;padding:5px" disabled></td>
							</tr>
