...
<table width="700" style="height:100px; margin-top:50px;">
	<tbody>
		...
		<tr>
			...
			<span class="design"> <?php echo $row['due_date']?> <span>

		<tr>

			<td width="175">
			<p  style='text-align:left;'>Date Billed:</p>
			<span class="design"> <?php echo $row['date_billled'] ?> <span>
			</td>
		</tr>
 ...
 ">
			...
			<span class="design"> <?php echo $row['from_date']. ' To '.$row['to_date'] ?> <span>
			</div>
			</td>
		</tr>
		...
		<tr>
			<td width="57">
			<span class="design" style="  font-weight:normal; ">  <?php echo $row['from_date']?> <span>

			</td>
			<td width="56">
			<span class="design" style="  font-weight:normal; ">  <?php echo $row['to_date']?> <span>
