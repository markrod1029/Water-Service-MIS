...
<center>
              ...
              <form method="POST" action="CRUD/send-inspections_install.php">
					...
					?>
							...
							<tr>
								<th>Create Meter No</th>
								<td style='background:white'><input type='text' name="meter_no"  style="border:solid;border-color:lightblue;border-width:1px;width:100%;padding:5px"></td>
