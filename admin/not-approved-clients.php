...
<section class="is-title-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <ul>
      ...
      <li style='color:black'>Disapproved Clients</li>
    </ul>
	<div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <h2 class="title">
    </h2>
			...
			<thead>
			  ...
			  <tbody>
					<?php
						...
						LEFT JOIN tbladdress ON tbladdress.address_ID = tblclients.address_ID WHERE  tblclients.Status = 5";
						...
						<td class="image-cell">
						  <div class="image">
						    <img class="pic"  src="<?php echo (!empty($row['picture']))? '../upload/ClientPicture/'.$row['picture']:'../upload/ClientPicture/'; ?>"
						...
						<td data-label="House_No"><?php echo $row['House_No']?></td>
						...
						<td data-label="Reg Date"><?php echo $row['RegDate']?></td>
						<td data-label="Status"> <?php echo $status?> </td>
						<td class="actions-cell">
						<div class='buttons right nowrap'>
						<button class='button small green' onclick=window.location.href="clients.php?ctid=<?php echo $row['cid'];?>"   type='button' name="print" >
							...
							<a type='button'onclick="return confirm('Are you sure you want to Deactive this User?')" href="CRUD/delete-client.php?id=<?php echo $row['cid'];?>" class='button small red --jb-modal' data-target='sample-modal' type='button'>
					...
					?>
						<tr>
							<td colspan='9' style='text-align:center;font-weight:bold;background:white'><br><br>--NO CLIENTS REJECT--</td>
						</tr>
					<?php }?>
