...
<section class="is-title-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <ul>
      ...
      <li style='color:black'>Inspections Result</li>
    </ul>
   ...
   <div class="  bg-gray-50" >
	...
	<table id="dataTable"  class="cell-border" >
			...
			<?php
						...
						WHERE inspection_schedule_for_registration_approval.inspected = 0 AND inspection_schedule_for_registration_approval.inspect_visted = 1 AND inspection_schedule_for_registration_approval.inspection_installation =0  ";
				...
				?>
						<tr>
							...
							<td data-label="Client Name"><?php echo $row['Barangay'].' '. $row['Municipality'].' '.$row['Province']?></td>
							...
							<form method='POST' action='send-inspection.php?id=<?php echo $row['sid'];?>'>
