...
<section class="is-title-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <ul>
      ...
      <li style='color:black'> Inspections and Installations Reports</li>
    </ul>
	...
	<table id="userTable"  class="cell-border" >
			...
			<th>Status</th>
			  ...
			  <tbody>
					...
					WHERE inspection_schedule_for_registration_approval.inspected =1 AND  inspection_schedule_for_registration_approval.inspection_installation =1 ORDER BY inspection_schedule_for_registration_approval.date_install DESC";
