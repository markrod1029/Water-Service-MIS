...
<section class="is-title-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <ul>
      ...
      <li style='color:black'>Client List</li>
	...
	<thead style='color:blueT; '>
			  ...
			  <tbody>
                    ...
                    $id = $_GET['ctid'];
						...
						LEFT JOIN tbladdress ON tbladdress.address_ID = tblclients.address_ID WHERE  tblclients.Status = 1 and tblclients.address_ID = '$id'";
					...
					?>
						<tr>
							<td colspan='7' style='text-align:center;font-weight:bold;background:white'><br><br>--NO CLIENTS    --</td>
						</tr>
					<?php }?>
