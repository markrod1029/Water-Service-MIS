...
<div class="print-are">
			<table width='100%' border='2' style="border-collapse:collapse;text-align:center;">
			  <tr>
				...
				<br><span style="text-align:center;padding:10px;font-weight:bold;color:black;font-family:arial black">(Daily Inspections and Installations )</span></td>
			  </tr>
			  <tr>
              <th>Meter No.</th>
			<th>Client Name</th>
			...
			<th>Date Installated</th>
					...
					LEFT JOIN tblplumber ON tblplumber.plumber_ID = inspection_schedule_for_registration_approval.plumber_ID  
                        WHERE DATE_FORMAT(inspection_schedule_for_registration_approval.date_install, '%Y-%m-%d') LIKE '$today%' AND
