...
<div class="print-are">
			<table width='100%' border='2' style="border-collapse:collapse;text-align:center;">
			  <tr>
				<td colspan='9' style="text-align:center;padding:10px;font-weight:bold;color:blue;font-family:arial black"><img src="../../images/logo.png" width="60px" height="60px" style="float:left" onclick="window.close()">URBIZTONDO WATER SERVICES	<br><span style="text-align:center;padding:10px;font-weight:bold;color:black;font-family:arial black">(Monthly Activity Log/s)</span></td>
			  </tr>
			  <tr>
              <th>Date</th>
				<th>Full Name</th>
                <th>Activities</th>
                    ...
                    $client = "SELECT * FROM activity  
                        WHERE DATE_FORMAT(time_loged, '%Y-%m') LIKE '$today%' AND
