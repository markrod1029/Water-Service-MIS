...
<div class="print-are">
			<table width='100%' border='2' style="border-collapse:collapse;text-align:center;">
			  <tr>
				...
				<br><span style="text-align:center;padding:10px;font-weight:bold;color:black;font-family:arial black">Annually Statement of Accounts</span></td>
			  </tr>
			  <tr>
              <th>Meter No.</th>
				<th>Client Name</th>
				...
				<th>Amount</th>
                    ...
                    $client = "SELECT *, billing.billing_ID AS bid FROM billing 
                        ...
                        WHERE DATE_FORMAT(billing.due_date, '%Y') LIKE '$today%'
