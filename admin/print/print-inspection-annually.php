...
<div class="print-are">
			<table width='100%' border='2' style="border-collapse:collapse;text-align:center;">
			  <tr>
				<td colspan='9' style="text-align:center;padding:10px;font-weight:bold;color:blue;font-family:arial black"><img src="../../images/logo.png" width="60px" height="60px" style="float:left" onclick="window.close()">URBIZTONDO WATER SERVICES	<br><span style="text-align:center;padding:10px;font-weight:bold;color:black;font-family:arial black">(Annually Inspections and Installations )</span></td>
			  </tr>
			  <tr>
              <th>Meter No.</th>
			<th>Client Name</th>
			...
			<th>Date Installated</th>
					...
					LEFT JOIN tblplumber ON tblplumber.plumber_ID = inspection_schedule_for_registration_approval.plumber_ID  
                        WHERE DATE_FORMAT(inspection_schedule_for_registration_approval.date_install, '%Y') LIKE '$today%' AND
