...
<div class="print-are">
			<table width='100%' border='2' style="border-collapse:collapse;text-align:center;">
			  <tr>
				<td colspan='9' style="text-align:center;padding:10px;font-weight:bold;color:blue;font-family:arial black"><img src="../../images/logo.png" width="60px" height="60px" style="float:left" onclick="window.close()">URBIZTONDO WATER SERVICES	<br><span style="text-align:center;padding:10px;font-weight:bold;color:black;font-family:arial black">(Daily Complaint )</span></td>
			  </tr>
			  <tr>
              <th>Meter No.</th>
				<th>Client Name</th>
                ...
                <th>Complaint/Concern</th>
                    ...
                    LEFT JOIN tblclients ON tblclients.client_ID = tblcomplaints.client_ID
                        WHERE DATE_FORMAT(inspection_schedule_for_complaints.date, '%Y-%m-%d') LIKE '$today%' AND
