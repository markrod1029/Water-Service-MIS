...
<div class="print-are">
			<table width='100%' border='2' style="border-collapse:collapse;text-align:center;">
			  <tr>
				...
				<br><span style="text-align:center;padding:10px;font-weight:bold;color:black;font-family:arial black">(Daily Advisory)</span></td>
			  </tr>
			  <tr>
              <th>What</th>
                <th>Reason</th>
				...
				<th>Affected Area/s</th>
                    ...
                    $client = "SELECT *,tbladvisory.advisory_ID AS aid FROM tbladvisory  
                        WHERE DATE_FORMAT(date, '%Y-%m-%d') LIKE '$today%' AND
