		...
		<table id="userTable"  class="cell-border">
			...
			<?php
					...
					LEFT JOIN tbladdress ON tbladdress.address_ID = tblclients.address_ID
						 WHERE billing.status  = 'Paid' ORDER BY date_billed.due_date DESC";
				...
				?>
						<tr>
							...
							<td data-label="Plumber Name"><?php echo $row['date_billled']?></td>
