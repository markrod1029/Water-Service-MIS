...
<nav class="secondary-nav" >
      ...
      <h3 class="login"style="margin-bottom:25px">LOG IN</h3>
        </center>
    ...
    <form action="login_porcess.php" method="POST">


                    <label style="margin-bottom:-15px">Email <span style="color:red">*</span></label>
                    <input type="text"  name="user" style="margin-bottom:15px">
                    <label style="margin-bottom:-15px">Password <span style="color:red">*</span></label>
                    <input type="password"   name="password" style="margin-bottom:25px">
                    <button class="btn-login" name="login">Login</button>
    
              <a class="form-check-label text-secondary text-right mr-4" href='forgot.php' style="font-size:18px; "> Forgot password? </a>
